...
$GetPermsPub = new PermsPub(); // Permissions Class
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	if ((isset($_POST['restoreperms'])) && ($_POST['restoreperms'] == 2)) {
		if ((isset($_POST['gid'])) && (is_numeric($_POST['gid']))) {
			...
			if ($QueryUpdate === true) {
				echo '<p align="alignCenter"><strong class="red">Group Permissions Updated.</strong></p>';
			} else {
				echo '<p align="alignCenter"><strong class="red">There was a problem with your submission.</strong></p>';
			}
		} else {
			echo '<p align="alignCenter"><strong class="red">There was a problem with your submission.</strong></p>';
		}
		...
		if ((isset($_POST['uid'])) && (is_numeric($_POST['uid']))) {
			...
			if ($QueryUpdate === true) {
				echo '<p align="alignCenter"><strong class="red">Group Permissions Restored.</strong></p>';
			} else {
				echo '<p align="alignCenter"><strong class="red">There was a problem with your submission.</strong></p>';
			}
		} else {
		...
		if ((isset($_POST['uid'])) && (is_numeric($_POST['uid']))) {
			...
			if ($QueryUpdate === true) {
				echo '<p align="alignCenter"><strong class="red">User Specific Permissions Updated.</strong></p>';
			} else {
				echo '<p align="alignCenter"><strong class="red">There was a problem with your submission.</strong></p>';
			}
		} else {
			  ...
			  <div class="alignCenter">
				...
				<?php if ($UserGroups !== false) {
					...
					foreach ($UserGroups as $GroupRow) {
						$html .= '<li><a href="?act=permissions&amp;gid=' . $GroupRow['id'] . '"><u>' . $GroupRow['title'] . '</u></a></li>';
						$i++;
					}
					$html .= '</ol>';
					echo $html;
